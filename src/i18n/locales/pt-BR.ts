...
export const ptBR: Locale = {
  ...
  install: {
    ...
    steps: [
      "Baixe o ZIP — é sempre a versão mais recente; este link nunca muda — e descompacte numa pasta que você vá manter.",
      "Abra chrome://extensions e ligue o Modo do desenvolvedor (no canto superior direito).",
      "Clique em Carregar sem compactação, escolha a pasta descompactada e depois é só clicar no cometa na barra de ferramentas.",
    ],
    download: "Baixar ZIP",
