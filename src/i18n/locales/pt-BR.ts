    ...
    items: [
      {
        ...
        body: "São 15 presets para os 12 provedores abaixo: faça login com a assinatura da Anthropic, da OpenAI ou da Kimi que você já paga, ou cole uma chave de API — além de qualquer endpoint que fale o formato da OpenAI ou da Anthropic. Sem lock-in e sem servidor no meio do caminho.",
      },
      {
