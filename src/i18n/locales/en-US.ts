...
export const enUS = {
  ...
  install: {
    ...
    steps: [
      "Download the ZIP — always the latest build; this link never changes — and unzip it somewhere you'll keep it.",
      "Open chrome://extensions and switch on Developer mode (top-right toggle).",
      "Click Load unpacked, pick the unzipped folder, then click the comet in your toolbar.",
    ],
